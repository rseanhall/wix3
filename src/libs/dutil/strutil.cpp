...
static HRESULT StrAllocHelper(
    __deref_out_ecount_part(cch, 0) LPWSTR* ppwz,
    __in DWORD_PTR cch,
    __in BOOL fZeroOnRealloc
    );
static HRESULT StrAllocStringHelper(
    __deref_out_ecount_z(cchSource + 1) LPWSTR* ppwz,
    __in_z LPCWSTR wzSource,
    __in DWORD_PTR cchSource,
    __in BOOL fZeroOnRealloc
    );
static HRESULT StrAllocConcatHelper(
    __deref_out_z LPWSTR* ppwz,
    __in_z LPCWSTR wzSource,
    __in DWORD_PTR cchSource,
    __in BOOL fZeroOnRealloc
    );
static HRESULT StrAllocFormattedArgsHelper(
    __deref_out_z LPWSTR* ppwz,
    __in BOOL fZeroOnRealloc,
...
{
    return StrAllocHelper(ppwz, cch, FALSE);
}
...
{
    return StrAllocHelper(ppwz, cch, TRUE);
}

/********************************************************************
StrAllocHelper - allocates or reuses dynamic string memory
...
{
    return StrAllocStringHelper(ppwz, wzSource, cchSource, FALSE);
}
...
{
    return StrAllocStringHelper(ppwz, wzSource, cchSource, TRUE);
}

/********************************************************************
StrAllocStringHelper - allocates or reuses dynamic string memory and copies in an existing string
If fZeroOnRealloc is true and the memory needs to reallocated, 
calls SecureZeroMemory on original block of memory after it is moved.
    ...
    )
{
    ...
    {
        cch = cchNeeded;
        hr = StrAllocHelper(ppwz, cch, fZeroOnRealloc);
...
{
    return StrAllocConcatHelper(ppwz, wzSource, cchSource, FALSE);
}
...
{
    return StrAllocConcatHelper(ppwz, wzSource, cchSource, TRUE);
}


/********************************************************************
StrAllocConcatHelper - allocates or reuses dynamic string memory and adds an existing string
If fZeroOnRealloc is true and the memory needs to reallocated, 
calls SecureZeroMemory on original block of memory after it is moved.
...
{
    return StrAllocFormattedArgsHelper(ppwz, FALSE, wzFormat, args);
}
...
{
    return StrAllocFormattedArgsHelper(ppwz, TRUE, wzFormat, args);
}


/********************************************************************
StrAllocFormattedArgsHelper - allocates or reuses dynamic string memory
and formats it with the passed in args.
